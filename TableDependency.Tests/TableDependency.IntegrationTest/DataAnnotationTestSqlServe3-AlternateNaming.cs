...
namespace TableDependency.IntegrationTest
{
    ...
    public class DataAnnotationTestSelServerModel3AlternateNaming
    {
    ...
    [TestClass]
    public class DataAnnotationTestSqlServer3AlternateNaming
    {
        ...
        public void EventForAllColumnsTest()
        {
            ...
            try
            {
                tableDependency = new SqlTableDependency<DataAnnotationTestSelServerModel3>(ConnectionString,null,null,null,null,DmlTriggerType.All,false,Constants.NAMINGTOKEN);
