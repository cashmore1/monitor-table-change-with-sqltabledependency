...
namespace TableDependency.IntegrationTest
{
    ...
    public class DataAnnotationTestSelServerModel5AlternateNaming
    {
    ...
    [TestClass]
    public class DataAnnotationTestSqlServer5AlternateNaming
    {
        ...
        public void EventForAllColumnsTest()
        {
            ...
            try
            {
                tableDependency = new SqlTableDependency<DataAnnotationTestSelServerModel5>(ConnectionString,null,null,null,null,DmlTriggerType.All,false,Constants.NAMINGTOKEN);
