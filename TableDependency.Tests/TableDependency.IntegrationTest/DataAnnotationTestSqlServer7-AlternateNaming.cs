...
{
    public class DataAnnotationTestSelServerModel7AlternateNaming
    {
    ...
    [TestClass]
    public class DataAnnotationTestSqlServer7AlternateNaming
    {
        ...
        public void EventForAllColumnsTest()
        {
            ...
            try
            {
                ...
                tableDependency = new SqlTableDependency<DataAnnotationTestSelServerModel7>(ConnectionString, dataBaseObjectNamePrefix: Constants.NAMINGTOKEN);
