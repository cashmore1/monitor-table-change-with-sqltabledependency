...
{
    public class DateTypeTestModelAlternateNaming
    {
    ...
    [TestClass]
    public class DateTypeTestAlternateNaming
    {
        ...
        public void CheckDateTypeTest()
        {
            ...
            try
            {
                tableDependency = new SqlTableDependency<DateTypeTestModel>(ConnectionString, TableName, dataBaseObjectNamePrefix: Constants.NAMINGTOKEN);
