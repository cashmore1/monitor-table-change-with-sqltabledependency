...
namespace TableDependency.IntegrationTest
{
    ...
    [TestClass]
    public class MargeTestSqlServerAlternateNaming
    {
        ...
        public void MergeTest()
        {
            ...
            try
            {
                tableDependency = new SqlTableDependency<MargeTestSqlServerModel>(ConnectionString, TargetTableName, dataBaseObjectNamePrefix: Constants.NAMINGTOKEN);
